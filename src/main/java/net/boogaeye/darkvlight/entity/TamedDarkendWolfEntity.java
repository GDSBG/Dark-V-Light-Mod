...
import net.boogaeye.darkvlight.entity.renderer.TamedDarkendWolfRenderer;
import net.boogaeye.darkvlight.DarkVsLightModElements;

@DarkVsLightModElements.ModElement.Tag
public class TamedDarkendWolfEntity extends DarkVsLightModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.1f, 1.25f)).build("tamed_darkend_wolf").setRegistryName("tamed_darkend_wolf");
	public TamedDarkendWolfEntity(DarkVsLightModElements instance) {
		super(instance, 368);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedDarkendWolfRenderer.ModelRegisterHandler());
