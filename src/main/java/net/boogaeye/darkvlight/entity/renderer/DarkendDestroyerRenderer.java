...
@OnlyIn(Dist.CLIENT)
public class DarkendDestroyerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DarkendDestroyerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDarkendFloater(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("dark_vs_light:textures/darkendfloatergreen.png");
					}
				};
			});
		}
