...
import net.boogaeye.darkvlight.entity.EnlightendTallendEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class EnlightendTallendRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EnlightendTallendEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDarkendTallend(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("dark_vs_light:textures/enlightendtallend.png");
					}
				};
			});
		}
