...
public class TamedSurvivorEntity extends DarkVsLightModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("tamed_survivor").setRegistryName("tamed_survivor");
	public TamedSurvivorEntity(DarkVsLightModElements instance) {
		super(instance, 433);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TamedSurvivorRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				TamedSurvivorRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				TamedSurvivorThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				DarkendSurviverOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
