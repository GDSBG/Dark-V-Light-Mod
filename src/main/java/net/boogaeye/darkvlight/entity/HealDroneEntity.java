...
import net.boogaeye.darkvlight.entity.renderer.HealDroneRenderer;
...
public class HealDroneEntity extends DarkVsLightModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("heal_drone").setRegistryName("heal_drone");
	public HealDroneEntity(DarkVsLightModElements instance) {
		super(instance, 548);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HealDroneRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -52429, -52225, new Item.Properties().group(DVLtabItemGroup.tab))
				.setRegistryName("heal_drone_spawn_egg"));
	}
