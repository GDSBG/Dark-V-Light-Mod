...
public class EnlightendGrassBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:enlightend_grass")
	public static final Block block = null;
	public EnlightendGrassBlock(DarkVsLightModElements instance) {
		super(instance, 587);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("enlightend_grass");
		}
