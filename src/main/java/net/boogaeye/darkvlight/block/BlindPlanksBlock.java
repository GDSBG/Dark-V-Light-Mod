...
public class BlindPlanksBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:blind_planks")
	public static final Block block = null;
	public BlindPlanksBlock(DarkVsLightModElements instance) {
		super(instance, 299);
	}
