...
public class EnchantedLogBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:enchanted_log")
	public static final Block block = null;
	public EnchantedLogBlock(DarkVsLightModElements instance) {
		super(instance, 581);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.SLIME).hardnessAndResistance(3f, 10f).setLightLevel(s -> 0).harvestLevel(3)
