...
public class HotDarkendFluidBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:hot_darkend_fluid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("dark_vs_light:hot_darkend_fluid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public HotDarkendFluidBlock(DarkVsLightModElements instance) {
		super(instance, 276);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("hot_darkend_fluid_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dark_vs_light:hot_darkend_fluid_lakes"),
					configuredFeature);
		}
	}
	@SubscribeEvent
