...
public class BlindLogBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:blind_log")
	public static final Block block = null;
	public BlindLogBlock(DarkVsLightModElements instance) {
		super(instance, 296);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.WOOD).hardnessAndResistance(10f, 10f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("blind_log");
		}
