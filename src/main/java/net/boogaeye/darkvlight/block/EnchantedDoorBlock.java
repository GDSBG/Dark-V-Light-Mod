...
public class EnchantedDoorBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:enchanted_door")
	public static final Block block = null;
	public EnchantedDoorBlock(DarkVsLightModElements instance) {
		super(instance, 595);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("enchanted_door");
		}
