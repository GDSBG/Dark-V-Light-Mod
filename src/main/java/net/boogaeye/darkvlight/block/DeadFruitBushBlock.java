...
public class DeadFruitBushBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:dead_fruit_bush")
	public static final Block block = null;
	public DeadFruitBushBlock(DarkVsLightModElements instance) {
		super(instance, 686);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("dead_fruit_bush");
		}
