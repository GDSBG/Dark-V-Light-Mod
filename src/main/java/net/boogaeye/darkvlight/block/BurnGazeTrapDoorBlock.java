...
public class BurnGazeTrapDoorBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:burn_gaze_trap_door")
	public static final Block block = null;
	public BurnGazeTrapDoorBlock(DarkVsLightModElements instance) {
		super(instance, 439);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("burn_gaze_trap_door");
		}
