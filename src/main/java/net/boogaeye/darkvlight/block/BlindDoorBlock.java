...
public class BlindDoorBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:blind_door")
	public static final Block block = null;
	public BlindDoorBlock(DarkVsLightModElements instance) {
		super(instance, 437);
	}
