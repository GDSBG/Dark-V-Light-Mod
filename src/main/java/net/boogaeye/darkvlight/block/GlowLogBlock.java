...
public class GlowLogBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:glow_log")
	public static final Block block = null;
	public GlowLogBlock(DarkVsLightModElements instance) {
		super(instance, 583);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 10f).setLightLevel(s -> 2).harvestLevel(2)
