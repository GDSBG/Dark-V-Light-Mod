...
public class BurnedGazeWoodBlock extends DarkVLightModElements.ModElement {
	@ObjectHolder("dark_v_light:burned_gaze_wood")
	public static final Block block = null;
	public BurnedGazeWoodBlock(DarkVLightModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(5f, 15f).lightValue(0).harvestLevel(2)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("burned_gaze_wood");
		}
