...
public class BasaltStoneFenceBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:basalt_stone_fence")
	public static final Block block = null;
	public BasaltStoneFenceBlock(DarkVsLightModElements instance) {
		super(instance, 536);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("basalt_stone_fence");
		}
