...
public class GlowLeavesBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:glow_leaves")
	public static final Block block = null;
	public GlowLeavesBlock(DarkVsLightModElements instance) {
		super(instance, 586);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.LILY_PADS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
