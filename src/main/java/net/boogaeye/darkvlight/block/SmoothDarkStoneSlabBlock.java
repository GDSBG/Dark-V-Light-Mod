...
public class SmoothDarkStoneSlabBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:smooth_dark_stone_slab")
	public static final Block block = null;
	public SmoothDarkStoneSlabBlock(DarkVsLightModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_dark_stone_slab");
		}
