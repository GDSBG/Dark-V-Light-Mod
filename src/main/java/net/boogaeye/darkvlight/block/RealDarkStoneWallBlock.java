...
public class RealDarkStoneWallBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:real_dark_stone_wall")
	public static final Block block = null;
	public RealDarkStoneWallBlock(DarkVsLightModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(2f, 35f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("real_dark_stone_wall");
		}
