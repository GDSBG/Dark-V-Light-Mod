...
public class LavaTrapDoorBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:lava_trap_door")
	public static final Block block = null;
	public LavaTrapDoorBlock(DarkVsLightModElements instance) {
		super(instance, 441);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("lava_trap_door");
		}
