...
public class HoloDoorBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:holo_door")
	public static final Block block = null;
	public HoloDoorBlock(DarkVsLightModElements instance) {
		super(instance, 580);
	}
