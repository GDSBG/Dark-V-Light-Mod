...
public class DarkendLavaWoodBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:darkend_lava_wood")
	public static final Block block = null;
	public DarkendLavaWoodBlock(DarkVsLightModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.WOOD).hardnessAndResistance(5f, 10f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.AXE).setRequiresTool().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("darkend_lava_wood");
		}
