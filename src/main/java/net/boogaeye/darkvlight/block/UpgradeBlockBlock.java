...
public class UpgradeBlockBlock extends DarkVLightModElements.ModElement {
	@ObjectHolder("dark_v_light:upgrade_block")
	public static final Block block = null;
	@ObjectHolder("dark_v_light:upgrade_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public UpgradeBlockBlock(DarkVLightModElements instance) {
		super(instance, 13);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("upgrade_block"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ANVIL).sound(SoundType.ANVIL).hardnessAndResistance(4f, 50f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("upgrade_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Special Block"));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("upgrade_block");
		}
