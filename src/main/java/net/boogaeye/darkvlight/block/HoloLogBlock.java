...
public class HoloLogBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:holo_log")
	public static final Block block = null;
	public HoloLogBlock(DarkVsLightModElements instance) {
		super(instance, 578);
	}
