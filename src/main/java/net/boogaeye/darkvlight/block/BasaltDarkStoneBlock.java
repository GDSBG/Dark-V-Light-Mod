...
public class BasaltDarkStoneBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:basalt_dark_stone")
	public static final Block block = null;
	public BasaltDarkStoneBlock(DarkVsLightModElements instance) {
		super(instance, 533);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(3f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().slipperiness(0.8f));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("basalt_dark_stone");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dark_vs_light:basalt_dark_stone_match"),
			...
			event.getRegistry().register(feature.setRegistryName("basalt_dark_stone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dark_vs_light:basalt_dark_stone"), configuredFeature);
		}
	}
	@SubscribeEvent
