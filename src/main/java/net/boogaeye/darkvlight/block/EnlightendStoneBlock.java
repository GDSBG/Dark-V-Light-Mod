...
public class EnlightendStoneBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:enlightend_stone")
	public static final Block block = null;
	public EnlightendStoneBlock(DarkVsLightModElements instance) {
		super(instance, 597);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("enlightend_stone");
		}
