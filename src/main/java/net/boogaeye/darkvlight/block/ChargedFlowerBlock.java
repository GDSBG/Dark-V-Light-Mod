...
import net.boogaeye.darkvlight.procedures.ChargedFlowerUpdateTickProcedure;
...
public class ChargedFlowerBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:charged_flower")
	public static final Block block = null;
	public ChargedFlowerBlock(DarkVsLightModElements instance) {
		super(instance, 598);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("charged_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dark_vs_light:charged_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("charged_flower");
		}
