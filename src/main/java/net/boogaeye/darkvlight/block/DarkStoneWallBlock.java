...
public class DarkStoneWallBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:smooth_dark_stone_wall")
	public static final Block block = null;
	public DarkStoneWallBlock(DarkVsLightModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_dark_stone_wall");
		}
