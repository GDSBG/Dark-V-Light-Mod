...
public class GlowLogDoorBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:glow_log_door")
	public static final Block block = null;
	public GlowLogDoorBlock(DarkVsLightModElements instance) {
		super(instance, 596);
	}
