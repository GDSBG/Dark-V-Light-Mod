...
public class BasaltStoneWallBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:basalt_stone_wall")
	public static final Block block = null;
	public BasaltStoneWallBlock(DarkVsLightModElements instance) {
		super(instance, 538);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(10f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("basalt_stone_wall");
		}
