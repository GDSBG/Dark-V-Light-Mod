...
public class EnchantedPlanksBlock extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:enchanted_planks")
	public static final Block block = null;
	public EnchantedPlanksBlock(DarkVsLightModElements instance) {
		super(instance, 582);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.SLIME).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(2)
