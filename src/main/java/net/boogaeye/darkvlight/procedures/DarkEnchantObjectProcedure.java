...
public class DarkEnchantObjectProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				DarkVsLightMod.LOGGER.warn("Failed to load dependency entity for procedure DarkEnchantObject!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		boolean AllowedArmor = false;
		ItemStack TempItemStack = ItemStack.EMPTY;
		double saveEnchant = 0;
		if (((new Object() {
			...
			if (((new Object() {
				...
				if (((EnchantmentHelper.getEnchantmentLevel(BlazingEnchantment.enchantment, (new Object() {
					...
					saveEnchant = (double) ((EnchantmentHelper.getEnchantmentLevel(BlazingEnchantment.enchantment, (new Object() {
						public ItemStack getItemStack(int sltid) {
							Entity _ent = entity;
							if (_ent instanceof ServerPlayerEntity) {
								Container _current = ((ServerPlayerEntity) _ent).openContainer;
					...
					}.getItemStack((int) (1))))) + 1);
					{
						...
						if (_enchantments.containsKey(BlazingEnchantment.enchantment)) {
							_enchantments.remove(BlazingEnchantment.enchantment);
					...
					}.getItemStack((int) (1)))).addEnchantment(BlazingEnchantment.enchantment, (int) saveEnchant);
				}
			} else if (((new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
				...
				if (((EnchantmentHelper.getEnchantmentLevel(DarkendProtectionEnchantment.enchantment, (new Object() {
					...
					saveEnchant = (double) ((EnchantmentHelper.getEnchantmentLevel(DarkendProtectionEnchantment.enchantment, (new Object() {
						public ItemStack getItemStack(int sltid) {
							Entity _ent = entity;
							if (_ent instanceof ServerPlayerEntity) {
								Container _current = ((ServerPlayerEntity) _ent).openContainer;
					...
					}.getItemStack((int) (1))))) + 1);
					{
						...
						if (_enchantments.containsKey(DarkendProtectionEnchantment.enchantment)) {
							_enchantments.remove(DarkendProtectionEnchantment.enchantment);
							EnchantmentHelper.setEnchantments(_enchantments, (new Object() {
								public ItemStack getItemStack(int sltid) {
									Entity _ent = entity;
									if (_ent instanceof ServerPlayerEntity) {
					...
					}.getItemStack((int) (1)))).addEnchantment(DarkendProtectionEnchantment.enchantment, (int) saveEnchant);
				}
			} else if (((new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
				...
				if (((EnchantmentHelper.getEnchantmentLevel(TeleportationEnchantment.enchantment, (new Object() {
					...
					saveEnchant = (double) ((EnchantmentHelper.getEnchantmentLevel(TeleportationEnchantment.enchantment, (new Object() {
						public ItemStack getItemStack(int sltid) {
							Entity _ent = entity;
							if (_ent instanceof ServerPlayerEntity) {
								Container _current = ((ServerPlayerEntity) _ent).openContainer;
					...
					}.getItemStack((int) (1))))) + 1);
					{
						...
						if (_enchantments.containsKey(TeleportationEnchantment.enchantment)) {
							_enchantments.remove(TeleportationEnchantment.enchantment);
							EnchantmentHelper.setEnchantments(_enchantments, (new Object() {
								public ItemStack getItemStack(int sltid) {
									Entity _ent = entity;
									if (_ent instanceof ServerPlayerEntity) {
					...
					}.getItemStack((int) (1)))).addEnchantment(TeleportationEnchantment.enchantment, (int) saveEnchant);
				}
			}
		}
	}
