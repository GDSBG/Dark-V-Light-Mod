...
public class DarkendSurviverOnEntityTickUpdateProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				DarkVsLightMod.LOGGER.warn("Failed to load dependency entity for procedure DarkendSurviverOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				DarkVsLightMod.LOGGER.warn("Failed to load dependency x for procedure DarkendSurviverOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				DarkVsLightMod.LOGGER.warn("Failed to load dependency y for procedure DarkendSurviverOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				DarkVsLightMod.LOGGER.warn("Failed to load dependency z for procedure DarkendSurviverOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				DarkVsLightMod.LOGGER.warn("Failed to load dependency world for procedure DarkendSurviverOnEntityTickUpdate!");
			return;
		}
		...
		}.getItemStack((int) (1), entity)).getItem())) {
			if (entity instanceof LivingEntity)
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) < ((entity instanceof LivingEntity)
				...
				: -1))) {
			if (((Math.random() * ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1)) < 0.005)) {
				if ((ItemTags.getCollection().getTagByID(new ResourceLocation(("seatable").toLowerCase(java.util.Locale.ENGLISH)))
						.contains((new Object() {
							public ItemStack getItemStack(int sltid, Entity entity) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								entity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
						...
						}.getItemStack((int) (6), entity)).getItem()))) {
					entity.getPersistentData().putBoolean("EatAllowed", (true));
				}
			}
			if ((entity.getPersistentData().getBoolean("EatAllowed"))) {
				if (entity instanceof LivingEntity) {
					ItemStack _setstack = (new Object() {
						public ItemStack getItemStack(int sltid, Entity entity) {
							AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				...
				entity.getPersistentData().putDouble("EatTick", ((entity.getPersistentData().getDouble("EatTick")) + 1));
				...
				if (((entity.getPersistentData().getDouble("EatTick")) == 24)) {
					if (world instanceof World && !world.isRemote()) {
						((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
				...
				if (((entity.getPersistentData().getDouble("EatTick")) == 32)) {
					if (world instanceof World && !world.isRemote()) {
						((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.generic.eat")),
								SoundCategory.NEUTRAL, (float) 1, (float) 1);
						...
						((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.REGENERATION, (int) 200, (int) 1, (false), (false)));
					{
						...
						}.getItemStack((int) (6), entity))).getCount()) - 1));
						entity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
					...
					entity.getPersistentData().putBoolean("EatAllowed", (false));
					entity.getPersistentData().putDouble("EatTick", 0);
				}
			}
		}
	}
