...
package net.boogaeye.darkvlight.world.dimension;
...
public class DarkendDimensionDimension extends DarkVLightModElements.ModElement {
	@ObjectHolder("dark_v_light:darkend_dimension")
	public static final ModDimension dimension = null;
	@ObjectHolder("dark_v_light:darkend_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public DarkendDimensionDimension(DarkVLightModElements instance) {
		super(instance, 11);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("darkend_dimension"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("dark_v_light:darkend_dimension")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("dark_v_light:darkend_dimension"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("dark_v_light:darkend_dimension"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("dark_v_light:burned_gaze_forest")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new DarkendDimensionItem().setRegistryName("darkend_dimension"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("darkend_dimension_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = DarkendDimensionDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("darkend_dimension_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "darkend_dimension_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = DarkendDimensionDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
