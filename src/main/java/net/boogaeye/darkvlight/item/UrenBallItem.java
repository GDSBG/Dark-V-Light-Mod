...
public class UrenBallItem extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:uren_ball")
	public static final Item block = null;
	public UrenBallItem(DarkVsLightModElements instance) {
		super(instance, 268);
	}
