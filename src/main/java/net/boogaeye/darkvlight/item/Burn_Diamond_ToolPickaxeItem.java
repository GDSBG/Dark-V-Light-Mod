...
public class Burn_Diamond_ToolPickaxeItem extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:burn_diamond_tool_pickaxe")
	public static final Item block = null;
	public Burn_Diamond_ToolPickaxeItem(DarkVsLightModElements instance) {
		super(instance, 206);
	}
