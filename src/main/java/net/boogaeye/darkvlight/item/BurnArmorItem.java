...
public class BurnArmorItem extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:burn_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("dark_vs_light:burn_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("dark_vs_light:burn_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("dark_vs_light:burn_armor_boots")
	public static final Item boots = null;
	public BurnArmorItem(DarkVsLightModElements instance) {
		super(instance, 196);
	}
