...
public class UrinArmorItem extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:urin_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("dark_vs_light:urin_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("dark_vs_light:urin_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("dark_vs_light:urin_armor_boots")
	public static final Item boots = null;
	public UrinArmorItem(DarkVsLightModElements instance) {
		super(instance, 253);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{2, 8, 10, 4}[slot.getIndex()];
			}
