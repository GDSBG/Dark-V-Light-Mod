...
public class StartileItem extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:startile")
	public static final Item block = null;
	public StartileItem(DarkVsLightModElements instance) {
		super(instance, 336);
	}
