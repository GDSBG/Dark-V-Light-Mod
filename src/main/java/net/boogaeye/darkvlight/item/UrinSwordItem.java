...
public class UrinSwordItem extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:urin_sword")
	public static final Item block = null;
	public UrinSwordItem(DarkVsLightModElements instance) {
		super(instance, 260);
	}
