...
public class BurnSwordItem extends DarkVsLightModElements.ModElement {
	@ObjectHolder("dark_vs_light:burn_sword")
	public static final Item block = null;
	public BurnSwordItem(DarkVsLightModElements instance) {
		super(instance, 280);
	}
